...
Không dùng số lượng nguồn như đại diện cho chất lượng. Một nguồn chính đúng phạm vi tốt hơn
nhiều bài lặp lại cùng thông cáo.
...
Nếu có nhiều file, overview phải chứa kết luận chung, phạm vi của từng file con và link tương
đối. Không lặp nguyên nội dung giữa các file.
