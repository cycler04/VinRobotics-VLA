...
[`docs/papers/long-horizon/`](../../papers/long-horizon/). Chỉ mục nguồn
chuẩn là [paper_link.txt](../../papers/long-horizon/paper_link.txt); các repo
công khai nằm ở [sota_co_code.md](sota_co_code.md).
...
|---|---|---|
| [hierarchical_agent/](hierarchical_agent/) | Suy ra subtask và tiếp nhận feedback ở tầng cao | [π0.5](hierarchical_agent/pi0_5.md), [Hi Robot](hierarchical_agent/hi_robot.md) |
| [memory_modules/](memory_modules/) | Giữ thông tin lịch sử khi quan sát hiện tại bị nhập nhằng | [MemoryVLA](memory_modules/memoryvla.md), [SeedPolicy](memory_modules/seedpolicy.md), [ReMem-VLA](memory_modules/remem_vla.md) |
| [future_prediction/](future_prediction/) | Dùng trạng thái, video hoặc action tương lai để điều kiện policy | [Seer](future_prediction/seer.md), [LingBot-VA](future_prediction/lingbot_va.md), [ACoT-VLA](future_prediction/acot_vla.md) |
...
3. **Code công khai không đồng nghĩa tái lập toàn bộ.** Năm paper có repo công
   ...
   [sota_co_code.md](sota_co_code.md).
...
- [Chỉ mục PDF và metadata](../../papers/long-horizon/paper_link.txt)
