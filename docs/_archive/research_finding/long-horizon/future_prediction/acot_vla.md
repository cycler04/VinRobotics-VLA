...
- Venue: CVPR 2026
- PDF trong repo: [docs/papers/long-horizon/acot_vla_action_chain_of_thought.pdf](../../../paper/long-horizon/acot_vla_action_chain_of_thought.pdf)
- Phân loại: **future prediction**. Lý do xếp ở đây thay vì hierarchical_agent:
  ...
  cùng vị trí trong pipeline với [Seer](seer.md) dự báo ảnh tương lai, chỉ khác
...
![1785726057775](image/acot_vla/1785726057775.png)
...
![1785726077993](image/acot_vla/1785726077993.png)
...
xạ khá sát với cách chia của [../tong_quan.md](../tong_quan.md): Linguistics
...
| [MemoryVLA](../memory_modules/memoryvla.md) | Linguistics      | 98.4    | 98.4   | 96.4 | 93.4           | 96.7           |
...
- ACoT-VLA bổ sung một **cột thứ tư** vào taxonomy ở
  [../tong_quan.md](../tong_quan.md): hướng dẫn ở **không gian action**, bên
...
| ----------------------------- | ----------------------------- | ---------------------------------------- |
| Ảnh RGB                      | [Seer](seer.md)             | Không (tự giám sát)                  |
| Latent video AR               | [LingBot-VA](lingbot_va.md) | Không (tự giám sát)                  |
