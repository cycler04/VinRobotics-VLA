...
- PDF trong repo: [docs/papers/long-horizon/lingbot_va_causal_world_modeling.pdf](../../../paper/long-horizon/lingbot_va_causal_world_modeling.pdf)
...
![1785484904923](image/lingbot_va/1785484904923.png)
...
![1785484930351](image/lingbot_va/1785484930351.png)
...
- Hai phát hiện có thể tách ra dùng ngay, độc lập kiến trúc:
  ...
  2. **FDM grounding cho async** — nếu định pipeline hoá dự đoán với thực thi
     (điều mà [realtime-chunking](../../realtime-chunking/) quan tâm), phải
...
3. **Đo latency tuyệt đối** của checkpoint công khai trên GPU consumer, đối chiếu
   ...
   [Hi Robot](../hierarchical_agent/hi_robot.md). Không paper nào cho phép so trực tiếp; ta tự đo được vì có checkpoint.
