...
- Trang chính thức: [Teaching Robots to Listen and Think Harder](https://www.pi.website/research/hirobot)
  (truy cập 2026-08-04)
- PDF trong repo: [docs/papers/long-horizon/hi_robot_hierarchical_vla.pdf](../../../paper/long-horizon/hi_robot_hierarchical_vla.pdf)
...
![1785308413890](image/hi_robot/1785308413890.png)
...
![1785819679719](image/hi_robot/1785819679719.png)
...
được ghi riêng ở
[Action expert Transformer dùng flow matching](../../gwen/module_details/VLAs/action_generation/flow_matching_transformer_expert.md);
...
- **Cross-paper baseline:** không có so sánh với π0.5, một hướng hợp nhất
  ...
  [report π0.5](pi0_5.md). Đây là quan sát khi đối chiếu hai paper, không phải
...
- Là bản "hai model" đối chiếu trực tiếp với bản "một model" của
  [pi0_5.md](pi0_5.md). Hai paper này nên đọc liền nhau.
...
- Số liệu độ trễ ở mục 4.9 là mốc tham chiếu hữu ích cho phần inference của
  [realtime-chunking](../../realtime-chunking/): 73 ms/bước tầng thấp trên
  GPU consumer.
