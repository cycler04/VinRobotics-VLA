...
| ----------------------------------------------------------- | -------------------------------------------------------- | ------------------------------------------ | ----------------------------------------------- |
| [`model.py`](details/03_model.md)                          | MLP-Mixer flow policy, flow-matching loss và ba sampler | observation, noise/action chunk, flow time | velocity hoặc action chunk`H=8`              |
| [`train_expert.py`](details/04_train_expert.md)            | Train expert actor-critic bằng PPO/RPO                  | 12 level Kinetix                           | expert`.pkl`, stats `.json`, video `.mp4` |
| [`generate_data.py`](details/05_generate_data.md)          | Chọn mixture expert và rollout demonstration           | expert checkpoint + stats                  | một`.npz` cho mỗi level                     |
| [`train_flow.py`](details/06_train_flow.md)                | Behavior cloning bằng conditional flow matching         | demonstration`.npz`                      | flow-policy`.pkl` theo epoch                  |
| [`eval_flow.py`](details/07_eval_flow.md)                  | Quét delay/horizon cho naive, RTC, BID và hard masking | flow checkpoint                            | `results.csv`                                 |
| [`render_levels.py`](details/08_render_levels.md)          | Render trạng thái ban đầu của level                 | `worlds/l/*.json`                        | 12 ảnh JPEG                                    |
| [`worlds/l` và Kinetix](details/09_kinetix_and_worlds.md) | Định nghĩa task và backend vật lý 2D               | JSON level                                 | `EnvState`, observation, transition, pixels   |
...
- [Cài đặt và cách dùng](02_usage.md)
- [Mô hình và các sampler](details/03_model.md)
- [Train expert](details/04_train_expert.md)
- [Sinh demonstration](details/05_generate_data.md)
- [Train flow policy](details/06_train_flow.md)
- [Đánh giá RTC](details/07_eval_flow.md)
- [Render level](details/08_render_levels.md)
- [Kinetix và world JSON](details/09_kinetix_and_worlds.md)
