...
- PDF trong repo: [docs/papers/retry-handle/robomonkey_test_time_sampling_verification.pdf](../../../papers/retry-handle/robomonkey_test_time_sampling_verification.pdf)
- Venue: **Unknown** — PDF không ghi venue. Chỉ mục citation của người dùng ghi
  ...
  được từ PDF.
- Phân loại: **action_generation** (cơ chế: test-time verification) — không sửa
  kiến trúc VLA, không huấn luyện lại policy, chỉ thêm compute và một verifier ở
  thời điểm deploy.
...
![1785483543462](image/robomonkey/1785483543462.png)
