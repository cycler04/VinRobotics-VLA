...
- PDF trong repo: [docs/papers/retry-handle/self_correcting_vla_sparse_world_imagination.pdf](../../../papers/retry-handle/self_correcting_vla_sparse_world_imagination.pdf)
...
- Đây là điểm nối rõ với [long-horizon/future_prediction](../../long-horizon/future_prediction/):
