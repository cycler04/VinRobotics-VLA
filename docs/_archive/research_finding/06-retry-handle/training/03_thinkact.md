...
- Venue: **arXiv preprint** 2507.16815v2, bản v2 ngày 18 Sep 2025 (v1: 22 Jul
  ...
  nào được nhận.
- PDF trong repo: [docs/papers/06-retry-handle/06_thinkact_reinforced_visual_latent_planning.pdf](../../../papers/06-retry-handle/06_thinkact_reinforced_visual_latent_planning.pdf)
