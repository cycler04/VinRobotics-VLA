...
[qwen_robotnav.md](qwen_robotnav.md). For the general model, see [qwen_vla.md](qwen_vla.md).
...
![Qwen-RobotManip training data corpus](image/qwen_robotmanip/training_data_corpus.png)
...
1. Yuan et al. *Qwen-RobotManip Technical Report: Alignment Unlocks Scale for Robotic
   ...
   [local PDF](../../papers/05-gwen/vla-specific/qwen_robotmanip_2606.17846.pdf) ·
