...
> **Full source of truth:** [Qwen-RobotNav complete report](qwen_robotnav_details.md). This short version
...
![Qwen-RobotNav architecture](Image/architecture_overview.png)
...
agent-facing interface.** See the [complete report](qwen_robotnav_details.md#all-agent-facing-task_mode-values)
...
![Qwen-RobotNav agentic system](Image/agentic_navigation_system.png)
...
![Qwen-RobotNav training distribution](Image/training_data_distribution.png)
