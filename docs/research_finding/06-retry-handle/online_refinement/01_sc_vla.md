...
- Phân loại: **online refinement** — thêm một policy residual học online bằng RL
  trên nền một base policy đóng băng, với reward sinh từ chính dự đoán của model.

⚠️ **Lưu ý ngữ nghĩa:** "self-correcting" ở đây **không** có nghĩa phát hiện lỗi
rồi phục hồi. Nó nghĩa là *policy tự tinh chỉnh action của mình online*. Ba paper
còn lại trong thư mục này nói về failure/recovery theo nghĩa đen; SC-VLA thì
không. Xếp chung vì cùng thuộc trục "sửa action sau khi base policy đã sinh ra
nó".
