...
- Phân loại: **failure recovery data** — can thiệp chính ở tầng dữ liệu
  (perturbation & bridging augmentation + reset demo), cộng orchestration bằng
  MLLM lúc deploy.
...
- **FLARE trả lời được câu hỏi RaC để mở.** RaC ([05-long-horizon/recovery_data](../../05-long-horizon/recovery_data/01_rac.md))
