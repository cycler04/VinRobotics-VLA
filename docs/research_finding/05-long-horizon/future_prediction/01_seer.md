...
- PDF trong repo: [docs/papers/05-long-horizon/03_seer_predictive_inverse_dynamics.pdf](../../../papers/05-long-horizon/03_seer_predictive_inverse_dynamics.pdf)
...
- Có code công khai (OpenRobotLab/Seer) — là paper duy nhất trong tập này có repo
  ...
  code" ở [.agents/01_overview.md](../../../../.agents/01_overview.md).
...
3. **Ghép Seer với memory**: Seer nhìn $m$ bước lịch sử cố định. Thử thay bằng
   PCMB của [MemoryVLA](../memory_modules/01_memoryvla.md) trên
