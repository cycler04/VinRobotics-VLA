# Long-horizon manipulation trong VLA — tổng hợp 7 paper còn lưu

## Ý tưởng chính

Corpus hiện tại gồm **bảy PDF gốc** và bảy báo cáo tương ứng. Chúng không trả lời
cùng một câu hỏi: hai paper xử lý phân rã task, hai paper duy trì trạng thái thời
...
| [memory_modules/](memory_modules/) | Giữ thông tin lịch sử khi quan sát hiện tại bị nhập nhằng | [MemoryVLA](memory_modules/01_memoryvla.md), [SeedPolicy](memory_modules/02_seedpolicy.md) |
...
## 4. Điều có thể kết luận từ bảy paper
